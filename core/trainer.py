 ...
 # learning rate scheduler, step
  ...
  def _train_epoch(self):
    ...
    for images, masks, _ in self.train_loader:
      ...
      # Generator
      # feats, pred_img = self.netG(inputs, masks, colors, normals, outlines)
      # input_1: inputs(depth_masked) 1*256*128
      ...
      self.add_summary(self.dis_writer, 'lr/dis_lr', self.get_lr(type='D')) #summary the process
